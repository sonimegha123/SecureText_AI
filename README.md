...
Deanonymization: Restores anonymized data to its original form when necessary.  
User-Friendly Interface: Simple, interactive web interface built with Gradio.  
